...
export const data = [
        ...
        
    {
        ...
        description:<p>The world’s top stars return – The top players in the world return, joined by some of the most exciting up-and-coming contenders. An all-star line-up of 19 players includes Nadal, Federer, Murray, Sharapova, Wozniacki and Williams.<br />Tennis stardom awaits – A totally new World Tour sees the VT career mode go &#39;RPG&#39;. Designed to encourage replay value and with an element of off-court fame, each decision affects a player’s career path meaning no two careers will ever be the same.<br />A true online hub for our community – The new online centre will offer the world’s first engaging online tennis experience. Designed using the popular Virtua Fighter 5 technology, the matchmaking system promises more competitive games, and online tournaments will seek to find the ultimate Virtua Tennis champion.<br />Experience the drama - A brand new on-court feature making for more dramatic matches. Build up your Match Momentum gauge over the course of a match and revel in your form as your player grows in confidence, allowing them to play shots mere mortals can only dream about.<br />Putting the fun back into mini-games – Breaking the mini-game mould to include new weather conditions and put a real focus on multiplayer action, the VT mini-games will give players a real alternative mode to compete in both multiplayer and online.</p>, 
        price:55, 
        pictureUrl:'https://media.rawg.io/media/screenshots/ec0/ec0a2193ad8a9cadd098aa379b6a1c6b_W3oActk.jpg',
        stock:7,
        category:"pc",
        released:'2011-04-29',
...

    {
        id:3, 
        title:'NBA 2K21', 
        description:<p>With extensive improvements upon its best-in-class graphics and gameplay, competitive and community online features, and deep, varied game modes, NBA 2K21 offers one-of-a-kind immersion into all facets of NBA basketball and culture - where Everything is Game.</p>, 
        price:75, 
        pictureUrl:'https://media.rawg.io/media/games/e79/e7901bf8d36cf8ebaf4886d8cd28c7e4.jpg',
        stock:3,
        category:"plastation",
        released:'2020-09-04',
...

    {
        ...
        description:<p>Forza Horizon 4 is the eleventh game in the Forza franchise of racing games and the fourth in the Horizon subseries.<br /><span>Premise</span>Forza Horizon 4 takes place in a shared open world that is loosely based on the United Kingdom. Up to 72 players can share a server at which they participate in races together. They can also purchase in-game homes, which allow the players to unlock faster cars and driver perks. The drivers are customizable up to their clothing and emotions.<br/><span>Weather and seasons</span><br/>Forza Horizon 4 has a dynamic change of weather and seasons that change on a weekly basis. The weather conditions are synchronized and shared by all players on the same server. The weather and seasons alter the environment and thus the gameplay. Conditions like snow, mud, and ice can influence not only the driving style but also which areas and routes are accessible during which season. Most notably, the players can drive on the ice when lakes and rivers freeze. <br/><span>Cars</span><br/>Forza Horizon 4 features more than 450 vehicles that are licensed by over one hundred car manufacturers. Among the few notable manufacturers that were not included because of licensing problems are Toyota and Lexus.<br/><span>Modes</span><br/>Although the game is oriented towards online multiplayer gameplay, it also has a single player and local multiplayer modes. The game also introduces a level editor mode called Route Creator that allows the players to design and customize new routes.</p>, 
        price:80, 
        pictureUrl:'https://media.rawg.io/media/games/082/082365507ff04d456c700157072d35db.jpg',
        stock:6,
        category:"xbox",
        released:'2021-11-09',
...

    {
        ...
        price: 75,
        pictureUrl: 'https://media.rawg.io/media/games/456/456dea5e1c7e3cd07060c14e96612001.jpg',
        stock: 4,
        category:'playstation',
        released: "2013-09-17",
    ...
    
    {
        id:6,
        title:'The Witcher 3',
        description: <p>The third game in a series, it holds nothing back from the player. Open world adventures of the renowned monster slayer Geralt of Rivia are now even on a larger scale. Following the source material more accurately, this time Geralt is trying to find the child of the prophecy, Ciri while making a quick coin from various contracts on the side. Great attention to the world building above all creates an immersive story, where your decisions will shape the world around you.<br/>CD Project Red are infamous for the amount of work they put into their games, and it shows, because aside from classic third-person action RPG base game they provided 2 massive DLCs with unique questlines and 16 smaller DLCs, containing extra quests and items.<br/>Players praise the game for its atmosphere and a wide open world that finds the balance between fantasy elements and realistic and believable mechanics, and the game deserved numerous awards for every aspect of the game, from music to direction.</p>,
        price: 75,
        pictureUrl: 'https://media.rawg.io/media/games/618/618c2031a07bbff6b4f611f10b6bcdbc.jpg',
        stock: 6,
        category:'xbox',
        released: "2015-05-18",
...

    {
        id:8,
        title:'Left 4 Dead 2',
        description: <p>Cooperative survival continues with a different set of characters. New survivors are making their way through 5 campaigns with an added ability to play through the story of the first game as well, using not only expanded arsenal of 20 ranged and 10 melee weapons but improved AI Director. Your surroundings and weather will change; enemy and item placement will differ from map to map, from difficulty to difficulty. New unique special zombies, placed in the unlucky for the player spot, can end your run.<br />High compatibility with community mods will allow you not only to add user-created maps but player models, enemy models, and even in-game music, which will help any player to create the unique experience on top of solid game mechanics.<br />Competitive multiplayer mods from arena survival to a head-on competition with another team of survivors are addictive and, in addition to the campaign, will provide you with hundreds of hours of game content.</p>,
        price: 55,
        pictureUrl: 'https://media.rawg.io/media/games/d58/d588947d4286e7b5e0e12e1bea7d9844.jpg',
        stock: 7,
        category:'pc',
        released: "2009-11-17",
    ...
    
    {
        ...
        description: <p>America, 1899. The end of the wild west era has begun as lawmen hunt down the last remaining outlaw gangs. Those who will not surrender or succumb are killed.<br/>After a robbery goes badly wrong in the western town of Blackwater, Arthur Morgan and the Van der Linde gang are forced to flee. With federal agents and the best bounty hunters in the nation massing on their heels, the gang must rob, steal and fight their way across the rugged heartland of America in order to survive. As deepening internal divisions threaten to tear the gang apart, Arthur must make a choice between his own ideals and loyalty to the gang who raised him.<br/>From the creators of Grand Theft Auto V and Red Dead Redemption, Red Dead Redemption 2 is an epic tale of life in America at the dawn of the modern age.</p>,
        price: 80,
        pictureUrl: 'https://media.rawg.io/media/games/511/5118aff5091cb3efec399c808f8c598f.jpg',
        stock: 5,
        category:'playstation',
        released: "2018-10-26",
